...
describe('EpicEditor', () => {
  ...
  it('preserves a conflict draft and re-applies it against a refreshed revision', () => {
    ...
    view.rerender({ send, actionResults: { 'epic-update-1': conflict } });
    ...
    view.rerender({ send, actionResults: { 'epic-update-1': conflict }, epic: epic({ title: 'Remote title', revision: 2 }) });
